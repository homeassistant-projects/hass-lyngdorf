...
class LyngdorfConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    def __init__(self):
        """Initialize the Lyngdorf config flow."""
        pass
    ...
    def async_get_options_flow(config_entry):
        ...
        return LyngdorfOptionsFlow(config_entry)
    ...
    async def async_step_user(
        ...
        LOG.debug(f'Starting Lyngdorf config flow with models: {COMPATIBLE_MODELS}')

        schema = LyngdorfConfigFlow.step_user_schema(COMPATIBLE_MODELS)
...
class LyngdorfOptionsFlow(OptionsFlow):
    ...
    async def async_step_sources(
        ...
        common_sources = [1] + list(range(3, 13)) + [24]  # HDMI, SPDIF 1-8, Internal Player, USB, ARC
        schema_dict = {}
